...
df, err = load_kpi("/kpi/diseases_by_gender")

if err:
    st.warning(f"Impossible de charger les données : {err}")
elif not df.empty:
    ...
    with col_a:
        df_diseases, _ = load_kpi("/kpi/diseases_repartition")
    ...
    with col_b:
        df_allerg, _ = load_kpi("/kpi/allergic_reparition")
